...
export const SOURCES: SourceRef[] = [
  ...
  {
    id: 'dequervain-ref',
    short: 'ドケルバン腱鞘炎（標準的知見）',
    title: 'de Quervain 病（手関節橈側の狭窄性腱鞘炎）の診断と治療に関する標準的知見',
    publisher: 'システマティックレビュー・各種教科書の要約',
    year: '—',
    note:
      '第1区画（長母指外転筋腱・短母指伸筋腱）の狭窄性腱鞘炎。産後・授乳期および更年期の女性に多く、産後例は断乳前後に軽快することが多い。母指を含む装具（thumb spica）と腱鞘内ステロイド注射の併用が最も奏効率が高い。第1区画に隔壁が存在しEPBが別区画となる例があり、注射無効の主要因となる。手術は第1区画開放術で、橈骨神経浅枝の損傷が最大の合併症。鑑別に母指CM関節症・橈骨神経浅枝障害・舟状骨骨折。',
  },
  {
    id: 'hip-gl-2016',
    short: '変形性股関節症GL2016',
